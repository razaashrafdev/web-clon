export const categories = [ 
    { id: 1, name: "Men's Fashion", slug: "mens-fashion", description: "Premium clothing and accessories for men", subcategories: ["Shirts", "T-Shirts", "Pants", "Jackets", "Accessories"], items: 245, count: "120 items", link: "/mens-fashion", color: "#4299e1" },
    { id: 2, name: "Women's Wear", slug: "wonen-wear", description: "Trendy fashion for women",subcategories: ["Dresses", "Tops", "Bottoms", "Outerwear", "Accessories"], items: 389, count: "245 items", link: "/womens-wear", color: "#ed64a6" },
    { id: 3, name: "Accessories", slug: "accessiries", count: "89 items", color: "#38b2ac" },
